...
def lstm_layer(tparams, state_below, options, prefix='lstm', mask=None):
    ...
    print ('state_below_1 :',state_below.shape)
    print ('  nsteps:',state_below.shape[0])
    print (type(nsteps), nsteps)
...
def train_lstm(
    ...
    # 如果我们设置了test_size的大小，这个步骤就是从测试集中随机找test_size个作为测试数据，如果没有设置test_size,会用所有的测试集数据做测试。
